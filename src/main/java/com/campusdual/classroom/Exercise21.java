...
public class Exercise21 {
    ...
    public static void main(String[] args) {
        ...
        boolean hashSetResult = addElementToSet(hashSet, "ELEMENT AAA");
        boolean treeSetResult = addElementToSet(treeSet, "ELEMENT AAA");


        System.out.println("Elemento añadido a HashSet: " + hashSetResult);
        System.out.println("Elemento añadido a TreeSet: " + treeSetResult);
